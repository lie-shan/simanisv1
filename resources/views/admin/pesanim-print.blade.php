...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-section td { border: none; padding: 2px 4px; }
        table.data {
            width: 100%;
...
<body>
    ...
    <div class="header">
        ...
        <h1>LAPORAN PENERIMAAN SANTRI BARU TAMAN PENDIDIKAN AL QUR'AN NURUL IMAN</h1>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="11" style="padding:20px;text-align:center;color:#999;">Tidak ada data</td>
            </tr>
            @endforelse
        </tbody>
    </table>
