...
<head>
    ...
    <title>Daftar — {{ $appShort ?? 'SIMANIS' }}</title>
...
<body>
    ...
    <div class="left-panel">
        ...
        <div class="form-container">
            <h2>Daftar</h2>
            <p class="sub">Buat akun baru untuk mengakses portal.</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group">
                    <input type="password" name="password" id="password" required autocomplete="new-password" placeholder="Password (min. 8 karakter)">
                    <button type="button" class="toggle-password" onclick="togglePass('password')" tabindex="-1">
                        <i class="fa-solid fa-eye-slash" id="passIcon"></i>
                    </button>
                </div>
                <div class="input-group">
                    <input type="password" name="password_confirmation" id="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password">
                    <button type="button" class="toggle-password" onclick="togglePass('password_confirmation')" tabindex="-1">
                        <i class="fa-solid fa-eye-slash" id="passConfIcon"></i>
                    </button>
                </div>
    ...
    function togglePass(id) {
        ...
        var icon = document.getElementById(id === 'password' ? 'passIcon' : 'passConfIcon');
        if (p.type === 'password') {
            p.type = 'text';
